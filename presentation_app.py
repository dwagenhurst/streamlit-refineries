...
# link to tableau
link = '[Tableau](https://public.tableau.com/app/profile/vitoria.moreno.costa/viz/TexasRefineriesandCancerRisk/Dashboard2?publish=yes)'
st.markdown(link, unsafe_allow_html=True)

# add rounding, fix table names, transpose table